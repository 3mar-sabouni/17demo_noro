...
const PaymentOptionWidget = publicWidget.Widget.extend({
    selector: '.oe_website_sale',
    events:  {
           'click .o_payment_option': '_onClickPaymentOption',
        },
    ...
    _handleProviderUpdateResult: function (result) {
            var $amountCod = $('#order_cod .monetary_field');
...
publicWidget.registry.PaymentOptionWidget = PaymentOptionWidget;
export default PaymentOptionWidget